...
func TestServiceStatusEndpoint(t *testing.T) {
	...
	freshMux := newDashboardMux(dc, nil, fresh, newRateLimiter(), nil, "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
	...
	mux := newDashboardMux(dc, nil, auth, newRateLimiter(), nil, "", nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestServiceStatusEndpointMergesPeer(t *testing.T) {
	...
	auth, _ := newConfirmedStore(t, "alice", "correct horse")
	mux := newDashboardMux(dc, nil, auth, newRateLimiter(), nil, "", nil, nil, nil, nil, nil, nil, nil, reg, nil, nil)
