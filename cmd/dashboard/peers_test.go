...
func TestPeerHandshakeHandlerValidSecret(t *testing.T) {
	h := peerHandshakeHandler("s3cret", "dashboard-a", "42", false, nil)
...
func TestPeerHandshakeHandlerWrongSecret(t *testing.T) {
	h := peerHandshakeHandler("s3cret", "dashboard-a", "dev", false, nil)
	req := httptest.NewRequest(http.MethodPost, "/peer/handshake", nil)
...
func TestPeerHandshakeHandlerEmptySecretDisabled(t *testing.T) {
	h := peerHandshakeHandler("", "dashboard-a", "dev", false, nil)
	req := httptest.NewRequest(http.MethodPost, "/peer/handshake", nil)
...
func TestPeerRegistryRecordsSuccess(t *testing.T) {
	srv := httptest.NewServer(peerHandshakeHandler("s3cret", "dashboard-b", "dev", false, nil))
	defer srv.Close()
...
func TestPeerRegistrySendCapturesVersion(t *testing.T) {
	srv := httptest.NewServer(peerHandshakeHandler("s3cret", "dashboard-b", "77", false, nil))
	defer srv.Close()
...
func TestURLForIdentityFound(t *testing.T) {
	...
	reg.recordResult("http://peer-b:8098", true, "dashboard-b", "42", false, nil)
