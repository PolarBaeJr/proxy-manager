...
func TestImagesMutationNoRegistry(t *testing.T) {
	...
	mux := newDashboardMux(localDC, nil, auth, newRateLimiter(), ic, "", nil, localOnb, localRS, nil, localIH, nil, nil, nil, nil, nil, nil)
...
func TestImagesMutationsLocalStillWork(t *testing.T) {
	...
	mux := newDashboardMux(dc, nil, auth, newRateLimiter(), ic, "", nil, onb, rs, nil, ih, nil, nil, nil, nil, nil, nil)
